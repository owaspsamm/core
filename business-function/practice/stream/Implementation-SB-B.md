...
maturity_levels:
    level1:
        ...
        question: Do you have solid knowledge of the dependencies you rely on?
        quality_criteria:
    ...
    level2:
        ...
        question: Do you handle third-party dependency risk through a formal process?
        quality_criteria:
    ...
    level3:
        ...
        question: Do you prevent the build of software if it is affected by vulnerabilities in dependencies?
        quality_criteria:
